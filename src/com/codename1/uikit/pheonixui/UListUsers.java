...
public class UListUsers extends BaseForm {
    ...
    serviceUtilisateur dao = serviceUtilisateur.getInstance();
    ...
    private Object[][] remplirUsers(List<User> _users) {
        ...
        for (int i = 0; i < lista.length; i++) {
            ...
            lista[i][1] = _users.get(i).getFirstName();
    ...
    public void chercher(String mot) {
        ...
        if (mot.equals("")) {
            ...
            for (User u : listUsers) {
                if (u.getEmail().contains(mot) || u.getFirstName().contains(mot) || u.getRoles().contains(mot)) {
                    listFiltrer.add(u);
                }
            }
        }
