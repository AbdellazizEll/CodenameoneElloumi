...
public class FEditPublication extends BaseForm{
    ...
    private com.codename1.ui.Button btnAnnuler = new com.codename1.ui.Button();
     ...
     public FEditPublication(Publication publ) {
        this(com.codename1.ui.util.Resources.getGlobalResources(),publ);
    }

    public FEditPublication(com.codename1.ui.util.Resources resourceObjectInstance,Publication publ) {
       idpublication=publ.getId();
        initGuiBuilderComponents(resourceObjectInstance);      
       remplirPublication(resourceObjectInstance,publ);
   ...
   public void remplirPublication(com.codename1.ui.util.Resources resourceObjectInstance,Publication pub) {
        
      titreText.setText(pub.getTitre_pub());
      contenuText.setText(pub.getContenu_pub());
     

      
      Image img;
        try {
            path=pub.getImagePub();
